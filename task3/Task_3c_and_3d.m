...
for trial = 1:numTrials
    ...
    net = setLearnRateFactor(net, "loss3-classifier/Weights", finalLayerWeightLearnRateFactor);
    net = setLearnRateFactor(net, "loss3-classifier/Bias", finalLayerBiasLearnRateFactor);
